...
export default function LoginModal({ isOpen, onClose, onSwitchToSignup }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      //const response = await fetch('http://localhost:8080/apiv2/auth/login', {
        method: 'POST',
        ...
        <div className="modal-dialog modal-dialog-centered mx-auto" style={{ maxWidth: '400px' }}>
          <div className="modal-content border-0 shadow-lg rounded-4 p-3">
            ...
            <div className="modal-header border-0 pb-0 justify-content-between align-items-center">
              <h5 className="modal-title fw-bold text-dark fs-4">Welcome Back</h5>
            ...
            <div className="modal-body py-3">
              ...
              <div className="text-center mt-2">
                <p className="small text-muted mb-0">
                  New to RiskCare?{' '}
                  <button onClick={onSwitchToSignup} className="btn btn-link p-0 small fw-bold text-decoration-none shadow-none" disabled={loading}>
                    Create account
                  </button>
                </p>
              </div>
